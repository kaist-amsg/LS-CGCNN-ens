...
def main():
	...
	for cv_idx in range(1,ncv+1):
		chk_name = 'CV_'+str(cv_idx)+'.ckpt.pth.tar'
		best_name = 'CV_'+str(cv_idx)+'.best.pth.tar'
		
		train_idx,val_idx,test_idx = split_loader(split_path,cv_idx)
		...
		print(best_checkpoint['best_mae_error'].numpy())
